...
public class ConfigGroupListVo {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ConfigGroupListVo)) return false;
        final ConfigGroupListVo other = (ConfigGroupListVo) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ConfigGroupListVo;
    }
