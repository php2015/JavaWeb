 ...
 */
@Service
public class BrandCompanyServiceImpl extends BaseServiceImpl<BrandCompanyMapper, BrandCompany>
        implements IBrandCompanyService {
