...
public class BrandCompanyListVo {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof BrandCompanyListVo)) return false;
        final BrandCompanyListVo other = (BrandCompanyListVo) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof BrandCompanyListVo;
    }
    ...
    public String toString() {
        return "BrandCompanyListVo(id=" + this.getId() + ", name=" + this.getName() + ", description=" + this.getDescription() + ", image=" + this.getImage() + ", imageUrl=" + this.getImageUrl() + ", sort=" + this.getSort() + ", createUser=" + this.getCreateUser() + ", createUserName=" + this.getCreateUserName() + ", createTime=" + this.getCreateTime() + ", updateUser=" + this.getUpdateUser() + ", updateUserName=" + this.getUpdateUserName() + ", updateTime=" + this.getUpdateTime() + ")";
    }
}