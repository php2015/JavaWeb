...
import com.kestrelcjx.admin.mapper.ProductAttributeValueMapper;
import com.kestrelcjx.admin.query.ProductAttributeValueQuery;
import com.kestrelcjx.admin.service.IProductAttributeValueService;
import com.kestrelcjx.admin.vo.ProductAttributeValueListVo;
...
public class ProductAttributeValueServiceImpl
        extends BaseServiceImpl<ProductAttributeValueMapper, ProductAttributeValue>
    ...
    public JsonResult getList(BaseQuery query) {
        ...
        // 查询数据
        IPage<ProductAttributeValue> page = new Page<>(productAttributeValueQuery.getPage(),
                productAttributeValueQuery.getLimit());
