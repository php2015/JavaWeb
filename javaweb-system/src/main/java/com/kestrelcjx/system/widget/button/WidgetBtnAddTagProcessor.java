...
public class WidgetBtnAddTagProcessor extends AbstractElementTagProcessor {
    ...
    protected void doProcess(ITemplateContext iTemplateContext, IProcessableElementTag iProcessableElementTag,
        ...
        // 这里是将字典的内容拼装成一个下拉框
        model.add(modelFactory.createOpenElementTag(String.format("a href=\"javascript:\" class=\"layui-btn btnOption" +
                "  layui-btn-small btnAdd\" id=\"add\" data-param='[%s]' lay-event=\"add\"", paramStr)));
