package com.kestrelcjx.system.widget.city;
...
public class WidgetCityComplexSelectTagProcessor extends AbstractElementTagProcessor {
    ...
    protected void doProcess(ITemplateContext iTemplateContext, IProcessableElementTag iProcessableElementTag,
        ...
        // 引入CSS
        model.add(modelFactory.createOpenElementTag("link rel=\"stylesheet\" type=\"text/css\"" +
                " href=\"/static/assets/module/city-picker/city-picker.css\" media=\"all\""));
        // 引入JS
        model.add(modelFactory.createOpenElementTag("script type=\"text/javascript\"" +
                " src=\"/static/assets/module/city-picker/city-picker.data.js\""));
        model.add(modelFactory.createCloseElementTag("script"));
        model.add(modelFactory.createOpenElementTag(String.format("input readonly id=\"%s\"" +
                        " name=\"%s\" lay-verify=\"%s\" placeholder=\"请选择%s\" autocomplete=\"off\"" +
                        " class=\"layui-input\" type=\"text\" data-toggle=\"city-picker\"",
                widgetName, widgetName, isRequire, showTips)));
        // 创建JS
        model.add(modelFactory.createOpenElementTag("script type=\"text/javascript\""));
