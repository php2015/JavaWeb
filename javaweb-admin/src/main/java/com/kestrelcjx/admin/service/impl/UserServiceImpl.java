...
import com.kestrelcjx.common.utils.QRCodeUtils;
...
import com.kestrelcjx.admin.constant.UserConstant;
import com.kestrelcjx.admin.entity.User;
import com.kestrelcjx.admin.mapper.UserMapper;
import com.kestrelcjx.admin.query.UserQuery;
import com.kestrelcjx.admin.service.IUserService;
...
import com.kestrelcjx.admin.vo.UserListVo;
    ...
    public JsonResult edit(User entity) {
        ...
        if (entity.getId() == null || entity.getId() == 0 || StringUtils.isEmpty(entity.getCode())) {
            ...
            try {
                ...
                QRCodeUtils.encodeQrCode(code, 500, 500, destImagePath);
