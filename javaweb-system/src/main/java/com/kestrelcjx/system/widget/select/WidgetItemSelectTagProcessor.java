...
import com.kestrelcjx.system.mapper.ItemCateMapper;
...
public class WidgetItemSelectTagProcessor extends AbstractElementTagProcessor {
    ...
    protected void doProcess(ITemplateContext iTemplateContext, IProcessableElementTag iProcessableElementTag,
        ...
        for (Map<String, Object> data : mapList) {
            ...
            model.add(modelFactory.createOpenElementTag(String.format("select name=\"%sId\" id=\"%sId\"" +
                    " lay-filter=\"%sId\" lay-search=\"\"", code, code, code)));
            ...
            for (Map<String, Object> item : list) {
                if (selected.equals(item.get("id"))) {
                    model.add(modelFactory.createOpenElementTag(String.format("option value=\"%s\" selected=\"\"",
                            item.get("id"))));
                } else {
