package com.kestrelcjx.system.widget.xmselect;
...
public class WidgetXmSelectTagProcessor extends AbstractElementTagProcessor {
    ...
    protected void doProcess(ITemplateContext iTemplateContext, IProcessableElementTag iProcessableElementTag,
        ...
        model.add(modelFactory.createOpenElementTag(
                String.format("div id=\"%s\" style=\"max-width: 400px;\"", showName)));
        ...
        if (!StringUtils.isEmpty(tagSql)) {
            ...
            try {
                ...
                // 创建树结构
                JSONArray result = listToTree(JSONArray.parseArray(JSON.toJSONString(mapList)),
                        "value", showPid, "children");
                // 引用JS
