...
public class WidgetSwitchCheckTagProcessor extends AbstractElementTagProcessor {
    ...
    protected void doProcess(ITemplateContext iTemplateContext, IProcessableElementTag iProcessableElementTag,
        ...
        stringBuffer3.append(String.format("input name=\"%s\" id=\"%s\" th:value=\"%s\" lay-skin=\"switch\"" +
                        " lay-filter=\"%s\" lay-text=\"%s\" type=\"checkbox\"",
                tagName, tagName, tagValue, tagName, tagData));
