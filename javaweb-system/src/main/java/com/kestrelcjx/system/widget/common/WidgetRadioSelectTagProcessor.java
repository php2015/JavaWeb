        ...
        if (!StringUtils.isEmpty(tagSql)) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (tagValue.contains(id)) {
                        model.add(modelFactory.createOpenElementTag(String.format("input type=\"radio\"" +
                                " name=\"%s\" value=\"%s\" title=\"%s\" checked=\"\"", showName, id, name)));
                    } else {
                        model.add(modelFactory.createOpenElementTag(String.format("input type=\"radio\"" +
                                " name=\"%s\" value=\"%s\" title=\"%s\"", showName, id, name)));
                    }
                }
            ...
            for (Map.Entry<Integer, String> item : map.entrySet()) {
                if (tagValue.contains(item.getKey().toString())) {
                    model.add(modelFactory.createOpenElementTag(String.format("input type=\"radio\"" +
                                    " name=\"%s\" value=\"%s\" title=\"%s\" checked=\"\"",
