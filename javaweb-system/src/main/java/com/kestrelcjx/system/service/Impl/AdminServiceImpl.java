...
import com.kestrelcjx.common.utils.DateUtils;
import com.kestrelcjx.common.utils.JsonResult;
import com.kestrelcjx.common.utils.StringUtils;
import com.kestrelcjx.system.constant.AdminConstant;
...
import com.kestrelcjx.system.mapper.LevelMapper;
import com.kestrelcjx.system.mapper.PositionMapper;
...
import com.kestrelcjx.system.vo.AdminInfoVo;
import com.kestrelcjx.system.vo.AdminListVo;
...
public class AdminServiceImpl extends ServiceImpl<AdminMapper, Admin> implements IAdminService {
    ...
    public JsonResult getList(BaseQuery query) {
        ...
        if (!StringUtils.isEmpty(adminQuery.getKeywords())) {
            queryWrapper.like("realname", adminQuery.getKeywords()).or().like("mobile",
                    adminQuery.getKeywords());
        }
        // 性别:1男 2女 3保密
